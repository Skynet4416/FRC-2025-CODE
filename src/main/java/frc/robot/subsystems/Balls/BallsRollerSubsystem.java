...
public class BallsRollerSubsystem extends SubsystemBase {
    ...
    public BallsRollerSubsystem() {
        this.rollerSparkMax = new SparkMax(Constants.Subsystems.Balls.Motors.ROLLER_SPARK_MAX_CAN_ID, SparkLowLevel.MotorType.kBrushless);
        ...
        this.rollerEncoder = rollerSparkMax.getAlternateEncoder();
